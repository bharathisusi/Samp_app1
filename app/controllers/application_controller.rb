class ApplicationController < ActionController::Base
  ...
  def append_vote_change(from_where)
    ...
    if singular_object == 'comment'
      ...
      render json: {html: render_to_string("/#{singular_object.pluralize}/_append_#{query_object[2]}_#{singular_object}_vote", layout: false, locals: {"question": query_object[0],"answer": query_object[1], "#{singular_object}": from_where})} and return
    else
